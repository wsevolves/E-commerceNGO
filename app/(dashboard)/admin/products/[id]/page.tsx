...
const DashboardProductDetails = ({
  ...
  const deleteProduct = async () => {
    ...
    fetch(`https://ngo-server-xyum.onrender.com/api/products/${id}`, requestOptions)
      .then((response) => {
  ...
  const uploadFile = async (file: any) => {
    ...
    try {
      const response = await fetch("https://ngo-server-xyum.onrender.com/api/main-image", {
        method: "POST",
        body: formData,
      });
  ...
  const fetchProductData = async () => {
    fetch(`https://ngo-server-xyum.onrender.com/api/products/${id}`)
      .then((res) => {
        return res.json();
      })
      .then((data) => {
    ...
    const imagesData = await fetch(`https://ngo-server-xyum.onrender.com/api/images/${id}`, {
      cache: "no-store",
    });
